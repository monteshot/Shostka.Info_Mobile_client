...
[assembly: Dependency(typeof(Sport.Mobile.Droid.PushNotifications))]
...
namespace Sport.Mobile.Droid
{
			...
			if(MainActivity.IsRunning)
			{
				try
				{
					...
					if(payloadValue != null)
					{
						...
						{
							MessagingCenter.Send(App.Instance, Messages.IncomingPayloadReceivedInternal, pl);
						});
					}
				}
				catch(Exception e)
	...
	public class PushHandlerService : GcmServiceBase
	{
		...
		protected override void OnRegistered(Context context, string registrationId)
		{
			try
			{
				App.Instance.CurrentAthlete.DeviceToken = registrationId;
